...
function populateMap(data2, i) {
    ...
    fontLink.setAttribute('href', 'https://fonts.googleapis.com/css2?family=DM+Sans');
    ...
    let headingStyle =
        ...
        "px;" +
        "font-family: " + convertToTitleCaseWithSpace(data2.headingField.fontFamily) +
        ";" +
        "color: " +
...
// Example usage:
// const inputString = "dmSans";
// const titleCaseString = convertToTitleCaseWithSpace(inputString);
// console.log(titleCaseString); // Output: "Dm Sans"
...
// Example usage:
// const inputString = "dmSans";
// const titleCaseString = convertToTitleCaseWithPlus(inputString);
// console.log(titleCaseString); // Output: "DM+Sans"